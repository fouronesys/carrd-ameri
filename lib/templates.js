...
function adminDashboard(opciones) {
  ...
  return [
    ...
    '.logout{font-size:12px;color:' + COLORES.tenue + ';text-decoration:none;border:1px solid ' + COLORES.borde + ';padding:8px 14px;border-radius:40px;}',
    ...
    '<div class="top"><h1>✦ Agendamientos</h1><form method="POST" action="/admin/logout" style="margin:0"><button class="logout" type="submit">Cerrar sesión</button></form></div>',
    '<div class="stats">',
    ...
    total === 0
      ...
      : '<div class="tabla-wrap"><table><thead><tr>' +
        '<th>Servicio</th><th>Valor</th><th>Cliente</th><th>Persona a trabajar</th><th>Foto</th><th>Información extra</th><th>Estado</th><th>Fecha</th>' +
