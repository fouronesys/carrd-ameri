...
async function listarAgendamientos() {
  const r = await q("SELECT data FROM agendamientos WHERE data->>'eliminado_en' IS NULL ORDER BY (data->>'trabajo_hecho') ASC NULLS LAST, data->>'creado_en' DESC NULLS LAST");
