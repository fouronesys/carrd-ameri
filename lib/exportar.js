...
function generarExcel(registros) {
  ...
  const anchos = [
    { wch: 28 }, { wch: 30 }, { wch: 18 }, { wch: 16 }, { wch: 22 },
    { wch: 24 }, { wch: 22 }, { wch: 18 }, { wch: 6  }, { wch: 12 },
    { wch: 40 }, { wch: 16 }, { wch: 22 }, { wch: 26 }, { wch: 18 },
    { wch: 18 },
  ];
  ws['!cols'] = anchos;
...
function generarPDF(registros, res) {
  ...
  const COLS = [
    ...
    { label: 'Cliente',             w: 68 },
    { label: 'Contacto',            w: 84 },
    { label: 'Persona a trabajar',  w: 70 },
    { label: 'Info extra',          w: 74 },
    { label: 'Comprob.',            w: 40 },
    { label: 'Estado',              w: 62 },
    { label: 'Trabajo',             w: 52 },
    { label: 'Fecha',               w: 68 },
