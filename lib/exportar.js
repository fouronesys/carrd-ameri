...
function generarExcel(registros) {
  ...
  const anchos = [
    { wch: 28 }, { wch: 30 }, { wch: 18 }, { wch: 22 }, { wch: 24 },
    { wch: 22 }, { wch: 18 }, { wch: 6  }, { wch: 40 }, { wch: 14 },
    { wch: 22 }, { wch: 26 }, { wch: 18 }, { wch: 18 },
  ];
  ws['!cols'] = anchos;
...
function generarPDF(registros, res) {
  ...
  const COLS = [
    { label: 'Servicio',            w: 100 },
    { label: 'Valor',               w: 58  },
    { label: 'Cliente',             w: 75  },
    { label: 'Contacto',            w: 95  },
    { label: 'Persona a trabajar',  w: 78  },
    { label: 'Info extra',          w: 92  },
    { label: 'Estado',              w: 56  },
    { label: 'Trabajo',             w: 56  },
    { label: 'Fecha',               w: 75  },
  ];
