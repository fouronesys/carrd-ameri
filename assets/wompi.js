(function () {
  ...
  function crearModal() {
    ...
    estilos.textContent = [
      '#wompi-overlay{display:none;position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.88);backdrop-filter:blur(5px);-webkit-backdrop-filter:blur(5px);align-items:center;justify-content:center;padding:1rem;}',
      '#wompi-overlay.activo{display:flex;}',
      '#wompi-modal{background:#100109;background-image:linear-gradient(360deg, rgba(0,0,0,0.72) 0%, rgba(125,55,84,0.10) 100%);border:solid 1px #C2A7B7;box-shadow:0 0 0 4px rgba(125,55,84,0.15), 0 20px 60px rgba(0,0,0,0.7);max-width:26rem;width:100%;max-height:90vh;overflow-y:auto;padding:1.6rem 1.5rem;font-family:"Poppins",sans-serif;color:#fff;position:relative;}',
      '#wompi-modal .wm-deco{text-align:center;color:#7D3754;font-size:0.7rem;letter-spacing:0.1em;margin-bottom:0.35rem;}',
      '#wompi-modal h3{text-align:center;color:#F0A3C3;font-size:1rem;font-weight:900;margin-bottom:0.9rem;letter-spacing:0.03em;text-transform:uppercase;}',
      '#wompi-modal h3 span{color:#9C4C6D;}',
      '#wompi-modal .wm-producto{text-align:center;font-size:0.85rem;font-weight:700;color:#fff;margin-bottom:0.15rem;line-height:1.35;}',
      '#wompi-modal .wm-precio{text-align:center;font-size:1.15rem;font-weight:900;font-style:italic;color:#F0A3C3;margin-bottom:1rem;}',
      '#wompi-modal .wm-divider{border:none;border-top:1px solid rgba(194,167,183,0.35);margin:0.9rem 0;}',
      '#wompi-modal .wm-aclaraciones-titulo{text-align:center;font-size:0.72rem;font-weight:700;color:#F0A3C3;letter-spacing:0.04em;margin-bottom:0.6rem;}',
      '#wompi-modal .wm-aclaraciones-titulo span{color:#9C4C6D;}',
      '#wompi-modal .wm-aclaraciones-lista{background:rgba(125,55,84,0.10);border:1px solid rgba(194,167,183,0.25);border-radius:0.3rem;padding:0.85rem 1rem;margin-bottom:0.85rem;max-height:9.5rem;overflow-y:auto;}',
      '#wompi-modal .wm-aclaraciones-lista li{font-size:0.66rem;color:#d6b9c8;line-height:1.55;margin-bottom:0.45rem;padding-left:1.1rem;position:relative;}',
      '#wompi-modal .wm-aclaraciones-lista li:last-child{margin-bottom:0;}',
      '#wompi-modal .wm-aclaraciones-lista li::before{content:"ꪮꫀ.";position:absolute;left:0;color:#9C4C6D;font-size:0.6rem;}',
      '#wompi-modal .wm-aclaraciones-lista li strong{color:#F0A3C3;}',
      '#wompi-modal .wm-aclaraciones-link{display:block;font-size:0.66rem;color:#F0A3C3;text-decoration:underline;margin-bottom:1rem;text-align:center;}',
      '#wompi-modal .wm-check-wrap{display:flex;align-items:flex-start;gap:0.6rem;margin-bottom:1.1rem;cursor:pointer;background:rgba(125,55,84,0.08);border:1px solid rgba(194,167,183,0.25);border-radius:0.3rem;padding:0.7rem 0.8rem;}',
      '#wompi-modal .wm-check-wrap input[type=checkbox]{width:1.05rem;height:1.05rem;min-width:1.05rem;accent-color:#7D3754;margin-top:0.1rem;cursor:pointer;}',
      '#wompi-modal .wm-check-wrap label{font-size:0.68rem;color:#e0c0cf;line-height:1.45;cursor:pointer;}',
      '#wompi-modal .wm-check-wrap label strong{color:#F0A3C3;}',
      '#wompi-modal .wm-btn-pagar{display:block;width:100%;padding:0.7rem;background-color:#7D3754;background-image:linear-gradient(360deg, rgba(0,0,0,0.72) 0%, rgba(125,55,84,0.012) 100%);color:#fff;font-family:"Poppins",sans-serif;font-size:0.78rem;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;border:solid 1px #C2A7B7;border-radius:3rem;cursor:pointer;transition:transform 0.125s ease,opacity 0.2s;text-align:center;text-decoration:none;}',
      ...
      '#wompi-modal .wm-btn-cerrar{position:absolute;top:0.7rem;right:0.9rem;background:none;border:none;color:#9C4C6D;font-size:1.25rem;cursor:pointer;line-height:1;transition:color 0.15s;}',
      '#wompi-modal .wm-btn-cerrar:hover{color:#F0A3C3;}',
      '#wompi-modal .wm-nota{font-size:0.6rem;color:#9c7788;text-align:center;margin-top:0.7rem;}',
      '.wm-pay-btn{display:inline-block;margin-top:0.55rem;padding:0.3rem 0.9rem;font-family:"Poppins",sans-serif;font-size:0.58rem;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:#fff;background-color:#7D3754;background-image:linear-gradient(360deg, rgba(0,0,0,0.72) 0%, rgba(125,55,84,0.012) 100%);border:solid 1px #C2A7B7;border-radius:3rem;cursor:pointer;transition:transform 0.125s ease;vertical-align:middle;}',
